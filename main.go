...
//	write(test)
	...
	//[13:51:05] Aliaksandr Valialkin: клиентом для данного сервиса будет выступать программа, генерирующая отчеты для конечных пользователей.
	...
	//[13:52:16] Aliaksandr Valialkin: большинство отчетов генерит максимум пару тысяч строчек, так что для них нет потребности в сортировке и пейджинации на нашей стороне
	...
	//[13:57:08] Aliaksandr Valialkin: о забыл добавить в набор входных параметров имя таблицы, из которой делать выборку :)
